                            ...
                            <div className="relative z-10 h-full flex flex-col">
                                ...
                                <div className="space-y-8 mt-auto lg:mt-0">
                                    <div className="flex items-start gap-4">
                                        ...
                                        <span className="text-white hover:text-white transition-colors cursor-pointer">1-267-226-1461</span>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <a href="sales@mboldend.com" className="text-teal-50 hover:text-white transition-colors">sales@mboldend.com</a>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-4">
                                        ...
                                        <span className="text-teal-50">Allentown, PA, USA</span>
                                    </div>
                                </div>
                            </div>
                        </div>
