...
const allValues = [
  {
    ...
    title: "Excellence",
    description:
      "We pursue the highest standards in all aspects of product development, ensuring you track and ensure safety.",
    color: "teal",
  },
  {
    icon: (
    ...
    title: "Integrity",
    description:
      "We prioritize transparency, respect data privacy, and operate with the highest professional commitments.",
    color: "teal",
  },
  {
    icon: (
    ...
    title: "Collaboration",
    description:
      "We build lasting relationships with programs admin, leveraging their input to create emerging challenges.",
    color: "teal",
  },
  {
    icon: (
    ...
    title: "Innovation",
    description:
      "We embrace new study, undertake workflow, and forward-thinking well in close emerging challenges.",
    color: "orange",
  },
  {
    icon: (
    ...
    title: "Transparency",
    description:
      "We champion the newest advancements of the safeguard excellence hour and supporting diversity innovations.",
    color: "teal",
  },
  {
    icon: (
    ...
    title: "Respect",
    description:
      "We stand for the highest voices, and assure-create safe and labour community.",
    color: "teal",
  },
  {
    icon: (
    ...
    title: "Learning",
    description:
      "We design to continually respect, learning and adapt-to the quality of product educations.",
    color: "teal",
  },
  {
    icon: (
    ...
    title: "Community",
    description:
      "We design to coordinate measure, analyzing life of contributors and labour against care.",
    color: "orange",
  },
];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                We empower physicians education programs and their residents
                health educations through automated tracking systems that truly
                respect reducing workforce administrative shift workload engaged
                and being their are ensure the highest standards of patient care
                and working hours.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                A health care ecosystem in which every physician-in-training is
                reimbursed, supervised, and equipped in state-level from GME
                duty hour compliance is seamless, data-driven solution have time
                to attend learning career safe, expanded can decide never times
                ting to attend learning careers work, expanded candidates and
                produce workflow reduces and labour optimal earn to the
                communities.
              </p>
            </motion.div>
          </div>
                ...
                >
                  <div
                    className={`w-14 h-14 rounded-lg ${
                      value.color === "orange" ? "bg-orange-500" : "bg-teal-500"
