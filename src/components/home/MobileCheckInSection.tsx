        ...
        <section className="lg:py-20 py-10 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <motion.div
                    ...
                    className="xl:mb-12 lg:mb-6 mb-4"
                >
                ...
                <div className=" ">
                    ...
                    >
                        <div className="w-[1000px] xl:h-[800px] lg:h-[700px] md:h-[600px] h-[400px] relative">
                            <Image
                        ...
                        <div className="flex justify-between  items-center">
                            ...
                            <div className="relative">
                                ...
                                <motion.div
                                    ...
                                    className=""
                                >
                                    <div className=" lg:max-w-xl max-w-lg mt-4 lg:mt-4 ">
